...
module.exports = {
  ...
  themeConfig: {
    nav: [
      ...
      {
        text: '前端开发', link: '/pages/d00ad7/'
      },
      {
        text: '测试开发', link: '/pages/ca725f/'
      },
      {
        text: '运维开发', link: '/pages/df4369/'
      },
      {
    ...
    author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, href: String}
      name: 'timchen525', // 必需
      href: 'https://github.com/timchen525/wow4j' // 可选的
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:461330266@qq.com'
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/timchen525'
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
    ...
    footer: { // 页脚信息
      ...
      copyrightInfo: 'timchen525 | MIT License', // 博客版权信息，支持a标签
    },
    htmlModules,
  },
  ...
  plugins: [
    ...
    [
      ...
      {
        hm: baiduCode || '256b0f411e8441cbb78d9124bf7f926a'
      }
    ],
